...
namespace NukaCode\Core\View\Helpers\LeftTab;
...
class Panel
{
     ...
     * @param array $options Extra options for the tab (Not Implemented Yet)
     *
     * @return $this
     */
    public function addTab($title, $path, $id = null, $options = [])
    {
        $newTab        = new \stdClass();
        $newTab->title = $title;
        $newTab->path  = $path;
